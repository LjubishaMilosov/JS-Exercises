const programmingWords = ["javascript", "hangman", "programming", "developer", "computer"];
...
function updateDisplay() {
    ...
    document.getElementById("scaffoldDisplay").innerText = scaffoldStages[maxLives - lives];
